...
import edu.ags.animallist.databinding.ActivityMainBinding;
                ...
                .setPositiveButton(R.string.OK,
                        new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                //Get the input
                                EditText txtAddItem = addView.findViewById(R.id.txtAddAnimal);
